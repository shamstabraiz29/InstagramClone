...
function modifyHelperUtil(action, generator, configFile = DEFAULT_WEBPACK_CONFIG_FILENAME, packages, autoSetDefaults = false, generateConfig = false, generationPath = '.') {
    ...
    env.run(generatorName, {
        ...
        try {
            ...
            return scaffold_1.runTransform(transformConfig, 'init', generateConfig, generationPath);
        }
        catch (error) {
            logger.error(error);
            process.exitCode = 2;
